...
application {
    mainClass.set("br.com.cinema.server.Application")
}
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("br.com.cinema.server.*")
    }
}
...
dependencies {
    ...
    implementation("io.micronaut.grpc:micronaut-grpc-server-runtime:3.1.0")
    ...
    implementation("io.micronaut.grpc:micronaut-protobuff-support:3.1.2")
}
